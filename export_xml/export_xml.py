...
HEADERS = {
    ...
    "Referer": "https://SUAEMPRESA.marketup.com/", # insira aqui a URL da sua empresa no MarketUP
...
START_DATE = "2025-07-27T00:00:00.000" # data de início da exportação
END_DATE   = "2025-08-13T23:59:59.999" # data de fim da exportação
...
# -------------------------
# 3 BAIXAR O ARQUIVO .ZIP COM OS XML DO PERÍODO SELECIONADO
# -------------------------
